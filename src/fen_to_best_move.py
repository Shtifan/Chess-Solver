...
def main():
    parser = argparse.ArgumentParser(
        description="Extract FEN from image and calculate best moves"
    )
    parser.add_argument(
        "--invert_fen",
        action="store_true",
        help="Invert FEN so white pieces are on bottom",
    )
    parser.add_argument(
        "--fen", help="Provide FEN directly instead of extracting from image"
    )
